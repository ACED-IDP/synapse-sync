...
setup(
    ...
    name='g3t_synapse_sync',  # Required
    ...
    url='https://github.com/ACED-IDP/synapse-sync.git',  # Optional
    ...
    entry_points={
        'console_scripts': [
            'g3t_synapse_sync = synapse_sync.cli:cli',
        ],
    },
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/ACED-IDP/synapse-sync/issues',
        'Source': 'https://github.com/ACED-IDP/synapse-sync',
    },
)
